...
def train():
    ...
    test_dataset = MAMeDataset(batch_size=batch_size, n_class=num_classes, mode='val')
    ...
    mdl_fit = model.fit_generator(
                            ...
                            epochs=n_epochs, verbose=1, validation_data=test_dataset #, callbacks=[early_stopping_monitor]
                            )
